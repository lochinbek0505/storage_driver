    ...
    try {
      if (_selectedFile1 != null) {
        ...
        Reference storageRef = storage.ref().child(
            'uploads/kirim_chiqim.xlsx'); // Change the file extension as needed
  ...
  Future<void> _downloadFile() async {
    try {
      ...
      Reference ref = storage.ref().child(
          'uploads/kirim_chiqim.xlsx'); // Change this to match your storage path
      Directory? directory =
          await getDownloadsDirectory(); // Get downloads directory
      if (directory != null) {
        File downloadToFile = File(
            '${directory.path}/kirim_chiqim.xlsx'); // File path in downloads directory
